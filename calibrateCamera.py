...
def calibrateCamera(chessboardSize, images):
    """
    Function to perform Zhang's camera calibration
    INPUT
    chessboardsize: dimension of chessboard in terms of squares
    images: Images used for calibration (located in CalibrationImages)
    """
    ...
    # images = glob.glob('CalibrationImages/*.jpg') # containing images of checkerboard
...
def undistort(img):
    ...
    img is an image containng a checkerboard
    It stores an undistorted image
    """ 
    ############## UNDISTORTION #####################################################
